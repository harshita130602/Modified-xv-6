...
int main(int argc, char *argv[])
{
  ...
  12:	a1 b4 0a 00 00       	mov    0xab4,%eax
  ...
  25:	39 1d b4 0a 00 00    	cmp    %ebx,0xab4
  2b:	7e 26                	jle    53 <main+0x53>
    int pid = fork();
  2d:	e8 08 03 00 00       	call   33a <fork>
    if (pid < 0)
  ...
  39:	83 c3 01             	add    $0x1,%ebx
      printf(1, "Fork failed\n");
  3c:	68 f8 07 00 00       	push   $0x7f8
  41:	6a 01                	push   $0x1
  43:	e8 58 04 00 00       	call   4a0 <printf>
      continue;
  48:	83 c4 10             	add    $0x10,%esp
  for (j = 0; j < number_of_processes; j++)
  4b:	39 1d b4 0a 00 00    	cmp    %ebx,0xab4
  ...
  ac:	3b 05 b4 0a 00 00    	cmp    0xab4,%eax
  b2:	7d c0                	jge    74 <main+0x74>
        if (k <= j)
...
free(void *ap)
{
 ...
 671:	a1 b8 0a 00 00       	mov    0xab8,%eax
{
 ...
 6ad:	89 08                	mov    %ecx,(%eax)
  freep = p;
 6af:	a3 b8 0a 00 00       	mov    %eax,0xab8
}
 6b4:	5b                   	pop    %ebx
 6b5:	5e                   	pop    %esi
 6b6:	5f                   	pop    %edi
 ...
 6c6:	72 ce                	jb     696 <free+0x26>
{
 ...
 6e7:	03 53 fc             	add    -0x4(%ebx),%edx
  freep = p;
 6ea:	a3 b8 0a 00 00       	mov    %eax,0xab8
    p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
 ...
 709:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 70c:	8b 15 b8 0a 00 00    	mov    0xab8,%edx
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 ...
 74f:	73 47                	jae    798 <malloc+0x98>
    ...
    if(p == freep)
 751:	39 05 b8 0a 00 00    	cmp    %eax,0xab8
 ...
 776:	e8 f5 fe ff ff       	call   670 <free>
  return freep;
 77b:	8b 15 b8 0a 00 00    	mov    0xab8,%edx
 ...
 7a4:	89 78 04             	mov    %edi,0x4(%eax)
      freep = prevp;
 7a7:	89 15 b8 0a 00 00    	mov    %edx,0xab8
}
 ...
 7b9:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
    base.s.ptr = freep = prevp = &base;
 7c0:	c7 05 b8 0a 00 00 bc 	movl   $0xabc,0xab8
 7c7:	0a 00 00 
 7ca:	c7 05 bc 0a 00 00 bc 	movl   $0xabc,0xabc
 7d1:	0a 00 00 
    base.s.size = 0;
 7d4:	b8 bc 0a 00 00       	mov    $0xabc,%eax
 7d9:	c7 05 c0 0a 00 00 00 	movl   $0x0,0xac0
 7e0:	00 00 00 
