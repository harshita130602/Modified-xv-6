...
main(int argc, char **argv)
{
  ...
  10:	83 ec 0c             	sub    $0xc,%esp
    int rc = fork();
  13:	e8 d2 02 00 00       	call   2ea <fork>

    if (rc < 0)
  18:	85 c0                	test   %eax,%eax
  1a:	78 6a                	js     86 <main+0x86>
    {
        printf(2, "fork error: fork failed!\n");
        exit();
    }
    else if (rc == 0)
  1c:	74 3b                	je     59 <main+0x59>
  ...
  21:	6a 04                	push   $0x4
  23:	e8 88 06 00 00       	call   6b0 <malloc>
        int * rtime = malloc(sizeof(int));
  28:	c7 04 24 04 00 00 00 	movl   $0x4,(%esp)
        int * wtime = malloc(sizeof(int));
  2f:	89 c3                	mov    %eax,%ebx
        int * rtime = malloc(sizeof(int));
  31:	e8 7a 06 00 00       	call   6b0 <malloc>
 ...
 3b9:	85 d2                	test   %edx,%edx
{
 ...
 3e7:	f7 f1                	div    %ecx
 3e9:	0f b6 92 3c 08 00 00 	movzbl 0x83c(%edx),%edx
  }while((x /= base) != 0);
...
printf(int fd, const char *fmt, ...)
{
 ...
 604:	e9 8f fe ff ff       	jmp    498 <printf+0x48>
          s = "(null)";
 609:	bb 34 08 00 00       	mov    $0x834,%ebx
        while(*s != 0){
