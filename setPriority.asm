  ...
  13:	83 39 03             	cmpl   $0x3,(%ecx)
{
  ...
  46:	56                   	push   %esi
  47:	50                   	push   %eax
  48:	e8 25 03 00 00       	call   372 <set_priority>
  4d:	89 c6                	mov    %eax,%esi
   printf(1, "Old: %d\nNew: %d\n", old, atoi(argv[2]));
  4f:	58                   	pop    %eax
  50:	ff 73 08             	pushl  0x8(%ebx)
  53:	e8 f8 01 00 00       	call   250 <atoi>
  58:	50                   	push   %eax
  59:	56                   	push   %esi
  5a:	68 b0 07 00 00       	push   $0x7b0
  5f:	6a 01                	push   $0x1
  61:	e8 ba 03 00 00       	call   420 <printf>
   exit();
  66:	83 c4 20             	add    $0x20,%esp
  69:	e8 54 02 00 00       	call   2c2 <exit>
  6e:	66 90                	xchg   %ax,%ax
...
printf(int fd, const char *fmt, ...)
{
 ...
 5d4:	e9 8f fe ff ff       	jmp    468 <printf+0x48>
          s = "(null)";
 5d9:	bb c1 07 00 00       	mov    $0x7c1,%ebx
        while(*s != 0){
...
free(void *ap)
{
 ...
 5f1:	a1 74 0a 00 00       	mov    0xa74,%eax
{
 ...
 62d:	89 08                	mov    %ecx,(%eax)
  freep = p;
 62f:	a3 74 0a 00 00       	mov    %eax,0xa74
}
 634:	5b                   	pop    %ebx
 635:	5e                   	pop    %esi
 636:	5f                   	pop    %edi
 ...
 646:	72 ce                	jb     616 <free+0x26>
{
 ...
 667:	03 53 fc             	add    -0x4(%ebx),%edx
  freep = p;
 66a:	a3 74 0a 00 00       	mov    %eax,0xa74
    p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
 ...
 689:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 68c:	8b 15 74 0a 00 00    	mov    0xa74,%edx
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 ...
 6cf:	73 47                	jae    718 <malloc+0x98>
    ...
    if(p == freep)
 6d1:	39 05 74 0a 00 00    	cmp    %eax,0xa74
 ...
 6f6:	e8 f5 fe ff ff       	call   5f0 <free>
  return freep;
 6fb:	8b 15 74 0a 00 00    	mov    0xa74,%edx
 ...
 724:	89 78 04             	mov    %edi,0x4(%eax)
      freep = prevp;
 727:	89 15 74 0a 00 00    	mov    %edx,0xa74
}
 ...
 739:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
    base.s.ptr = freep = prevp = &base;
 740:	c7 05 74 0a 00 00 78 	movl   $0xa78,0xa74
 747:	0a 00 00 
 74a:	c7 05 78 0a 00 00 78 	movl   $0xa78,0xa78
 751:	0a 00 00 
    base.s.size = 0;
 754:	b8 78 0a 00 00       	mov    $0xa78,%eax
 759:	c7 05 7c 0a 00 00 00 	movl   $0x0,0xa7c
 760:	00 00 00 
