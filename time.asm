...
main(int argc, char **argv)
{
  ...
  14:	8b 71 04             	mov    0x4(%ecx),%esi
    int rc = fork();
  17:	e8 ce 02 00 00       	call   2ea <fork>

    if (rc < 0)
  1c:	85 c0                	test   %eax,%eax
  1e:	78 64                	js     84 <main+0x84>
        printf(2, "fork error: fork failed!\n");
    else if (rc == 0){ 
  20:	74 41                	je     63 <main+0x63>
        exec(argv[1], argv + 1);
  ...
  27:	6a 04                	push   $0x4
  29:	e8 82 06 00 00       	call   6b0 <malloc>
        int * wtime = malloc(sizeof(int));
  2e:	c7 04 24 04 00 00 00 	movl   $0x4,(%esp)
        int * rtime = malloc(sizeof(int));
  35:	89 c7                	mov    %eax,%edi
        int * wtime = malloc(sizeof(int));
  37:	e8 74 06 00 00       	call   6b0 <malloc>
  ...
  40:	57                   	push   %edi
  41:	56                   	push   %esi
  42:	e8 4b 03 00 00       	call   392 <waitx>
  ...
  4c:	ff 36                	pushl  (%esi)
  4e:	53                   	push   %ebx
  4f:	68 dc 07 00 00       	push   $0x7dc
  54:	6a 01                	push   $0x1
  56:	e8 f5 03 00 00       	call   450 <printf>
  5b:	83 c4 20             	add    $0x20,%esp
    }
    exit();
  5e:	e8 8f 02 00 00       	call   2f2 <exit>
        exec(argv[1], argv + 1);
  63:	50                   	push   %eax
  64:	50                   	push   %eax
  65:	8d 46 04             	lea    0x4(%esi),%eax
  68:	50                   	push   %eax
  69:	ff 76 04             	pushl  0x4(%esi)
  6c:	e8 b9 02 00 00       	call   32a <exec>
        printf(2, "exec error: exec failed!\n");
  71:	58                   	pop    %eax
  72:	5a                   	pop    %edx
  73:	68 c2 07 00 00       	push   $0x7c2
  78:	6a 02                	push   $0x2
  7a:	e8 d1 03 00 00       	call   450 <printf>
  7f:	83 c4 10             	add    $0x10,%esp
  82:	eb da                	jmp    5e <main+0x5e>
        printf(2, "fork error: fork failed!\n");
  84:	51                   	push   %ecx
  85:	51                   	push   %ecx
  86:	68 a8 07 00 00       	push   $0x7a8
  8b:	6a 02                	push   $0x2
  8d:	e8 be 03 00 00       	call   450 <printf>
  92:	83 c4 10             	add    $0x10,%esp
  95:	eb c7                	jmp    5e <main+0x5e>
  97:	66 90                	xchg   %ax,%ax
  99:	66 90                	xchg   %ax,%ax
  9b:	66 90                	xchg   %ax,%ax
  9d:	66 90                	xchg   %ax,%ax
 ...
 3b9:	85 d2                	test   %edx,%edx
{
 ...
 3e7:	f7 f1                	div    %ecx
 3e9:	0f b6 92 40 08 00 00 	movzbl 0x840(%edx),%edx
  }while((x /= base) != 0);
...
printf(int fd, const char *fmt, ...)
{
 ...
 604:	e9 8f fe ff ff       	jmp    498 <printf+0x48>
          s = "(null)";
 609:	bb 38 08 00 00       	mov    $0x838,%ebx
        while(*s != 0){
 ...
 621:	a1 f0 0a 00 00       	mov    0xaf0,%eax
{
 ...
 65d:	89 08                	mov    %ecx,(%eax)
  freep = p;
 65f:	a3 f0 0a 00 00       	mov    %eax,0xaf0
}
 664:	5b                   	pop    %ebx
 665:	5e                   	pop    %esi
 666:	5f                   	pop    %edi
...
malloc(uint nbytes)
{
 ...
 6ff:	73 47                	jae    748 <malloc+0x98>
    ...
    if(p == freep)
 701:	39 05 f0 0a 00 00    	cmp    %eax,0xaf0
 ...
 726:	e8 f5 fe ff ff       	call   620 <free>
  return freep;
 72b:	8b 15 f0 0a 00 00    	mov    0xaf0,%edx
 ...
 754:	89 78 04             	mov    %edi,0x4(%eax)
      freep = prevp;
 757:	89 15 f0 0a 00 00    	mov    %edx,0xaf0
}
 ...
 769:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
    base.s.ptr = freep = prevp = &base;
 770:	c7 05 f0 0a 00 00 f4 	movl   $0xaf4,0xaf0
 777:	0a 00 00 
 77a:	c7 05 f4 0a 00 00 f4 	movl   $0xaf4,0xaf4
 781:	0a 00 00 
    base.s.size = 0;
 784:	b8 f4 0a 00 00       	mov    $0xaf4,%eax
 789:	c7 05 f8 0a 00 00 00 	movl   $0x0,0xaf8
 790:	00 00 00 
